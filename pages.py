...
# (All other page functions — page_role_select, page_home, page_bets, page_bet_detail, page_create_bet, page_achievements, page_shop, page_leaderboard, page_my_profile, page_how_it_works, page_clips — are the same as you had in your last message. Paste them here exactly as they were.)

# For brevity in this response I stopped at page_auth. Paste the rest of your page functions exactly as you had them after this point.
